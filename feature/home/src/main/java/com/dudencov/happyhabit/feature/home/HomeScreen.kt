...
private fun BottomBar(
    ...
    BottomAppBar(
        actions = {
            IconButton(
                modifier = Modifier.testTag(HomeTestTags.WEEKLY_BTN.tag),
            ...
            IconButton(
                modifier = Modifier.testTag(HomeTestTags.SETTINGS_BTN.tag),
                onClick = {
...
private fun Fab(
    ...
    FloatingActionButton(
        modifier = Modifier.testTag(HomeTestTags.FAB.tag),
        onClick = {
            onIntent(HomeIntent.OnFabClicked)
        }) {
        Icon(
...
private fun HabitItem(
    ...
    Card(
        ...
        modifier = Modifier
            ...
            .clickable { onIntent(
                HomeIntent.OnHabitClicked(
                    id = item.habit.id,
                    name = item.habit.name
                )
            ) }
            .testTag(HomeTestTags.LIST_ITEM.tag),
    ) {
        Row(
...
private fun HabitItemMenu(
    ...
    Box(
        ...
        IconButton(
            modifier = Modifier.testTag(HomeTestTags.LIST_BTN_MENU.tag),
            onClick = {
                onIntent(
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                ...
                modifier = Modifier.testTag(HomeTestTags.LIST_DROPDOWN_MENU_DELETE_ITEM.tag),
            )
        }
    }
}

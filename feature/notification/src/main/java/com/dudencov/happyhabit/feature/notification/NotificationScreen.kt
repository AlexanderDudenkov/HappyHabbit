...
private fun TopBar(
    ...
    Surface(
        ...
        TopAppBar(
            ...
            title = { Text(text = context.getString(UiR.string.notification_settings_title)) },
            navigationIcon = {
                IconButton(onClick = { onIntent(NotificationIntent.OnNavigateBack) }) {
                    Icon(
                        imageVector = Icons.AutoMirrored.Filled.ArrowBack,
                        contentDescription = stringResource(UiR.string.button_back_content_desk),
                    )
                }
            }
        )
...
private fun HabitNotificationItem(
    ...
    Card(
        ...
        Row(
            ...
            Text(
                text = stringResource(UiR.string.notification_settings_reminder),
            ...
            Switch(
                ...
                onCheckedChange = {
                    onIntent(
                        NotificationIntent.OnSwitchItem(
...
private fun TimePickerDialog(
    ...
    androidx.compose.material3.AlertDialog(
        ...
        title = { Text(text = stringResource(UiR.string.select_reminder_time)) },
        text = {
        ...
        confirmButton = {
            androidx.compose.material3.TextButton(
                ...
                Text(text = stringResource(UiR.string.confirm))
            }
        },
        dismissButton = {
